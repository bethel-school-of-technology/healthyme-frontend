    ...
    render() {
        return (
            <div>
                ...
                <h3>Step 1: Create client's user profile here: <Link to="/createUser" className="nav-link">Create User</Link></h3>
                <br></br>

                {/* <h3>Step 2: Login to your account here: <Link to="/login" className="nav-link">Login</Link></h3>
                <br></br> */}

                <h3>Step 2: Enter exercise data here: <Link to="/exerciseEntry" className="nav-link">Exercise Entry</Link></h3>
            </div>
